...
vzr=[]
flag_end=False
fire_audio=pygame.mixer.Sound('./audio/fire.wav')
fire_frag_audio=pygame.mixer.Sound('./audio/fire_frag.wav')
uron_audio=pygame.mixer.Sound('./audio/uron.wav')
vzr_audio=pygame.mixer.Sound('./audio/vzr.wav')
...
async def main():
    ...
    global FPS,flag_end,red_nebo,rocketx,rockety,asl,sperm,sperm_sc,start_time,score,energy,fire_time
    while True:
